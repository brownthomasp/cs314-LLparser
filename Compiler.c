...
static int digit()
{
//	printf("DEBUG: func 'digit' got token %c\n", token);
...
{
//	printf("DEBUG: func 'variable' got token %c\n", token);
...
static int expr()
{
//	printf("DEBUG: func 'expr' got token %c\n", token);
...
static void assign()
{
//	printf("DEBUG: func 'assign' got token %c\n", token);
...
static void read()
{
//	printf("DEBUG: func 'read' got token %c\n", token);

	char ident;

	if (token != '?') {
		ERROR("Expected question mark for read statement\n");
		exit(EXIT_FAILURE); 
	}
...
{
//	printf("DEBUG: func 'print' got token %c\n", token);
...
static void stmt()
{
//	printf("DEBUG: func 'stmt' got token %c\n", token);
...
static void morestmts()
{
//	printf("DEBUG: func 'morestmts' got token %c\n", token);
...
static void stmtlist()
{
//	printf("DEBUG: func 'stmtlist' got token %c\n", token);
	stmt();
	morestmts();
}
...
static void program()
{
//	printf("DEBUG: func 'program' got token %c\n", token);
        stmtlist();
...
int main(int argc, char *argv[])
{
	...
	buffer = input;
	printf("DEBUG: func 'main' got input: %s\n", buffer);
	program();
